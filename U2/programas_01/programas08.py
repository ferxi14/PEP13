...
print("Jugador 1: dados =", dado1_j1, "y", dado2_j1, "→ total =", total_j1)
print("Jugador 2: dados =", dado1_j2, "y", dado2_j2, "→ total =", total_j2)
...
if total_j1 > total_j2:
    ...
    if max_j1 > max_j2:
        print("Gana el jugador 1 (por el dado más alto).")
    elif max_j2 > max_j1:
        print("Gana el jugador 2 (por el dado más alto).")
    else:
        print("Empate total.")